...
const cases: Record<PracticeVolume, Seed[]> = {
  ...
  senior: [
    ...
    { title: "Экстремальный float", level: "Коллекционер", key: "подтверж", hint: "Крайнее значение требует аналогов и аудитории.", solution: "Верное рассуждение: не называть премию без подтверждённых похожих предметов." },
    { title: "Редкий pattern", level: "Коллекционер", key: "вид", hint: "Сначала нужен визуальный осмотр конкретного предмета.", solution: "Верное решение: проверить seed, внешний вид и сопоставимые предложения." },
    { title: "Craft", level: "Коллекционер", key: "композиц", hint: "Оценивайте композицию, слот и wear, а не сумму цен наклеек.", solution: "Верное рассуждение: craft ищет свою аудиторию и не имеет автоматической премии." },
  ],
  applied: [
